...
// sample data type is the FullTemplateFooType class, and we're making a variable called pFullTemplateFooType.
...
DATATYPE(FullTemplateFooType,pFullTemplateFooType,0);
